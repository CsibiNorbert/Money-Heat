...
infosoftglobal.FusionCharts = function(swf,
    id,
    w,
    h,
    debugMode,
...
infosoftglobal.FusionChartsUtil.getPlayerVersion = function() {
    ...
    if (navigator.plugins && navigator.mimeTypes.length) {
        ...
        if (x && x.description) {
            PlayerVersion = new infosoftglobal.PlayerVersion(x.description.replace(/([a-zA-Z]|\s)+/, "")
