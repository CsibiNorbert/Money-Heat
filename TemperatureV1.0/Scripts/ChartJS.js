                            ...
                            updateElement: function(rectangle, index, reset) {
                                ...
                                rectangle._model = {
                                    ...
                                    borderColor: custom.borderColor
                                        ? custom.borderColor
                                        : helpers.valueAtIndexOrDefault(dataset.borderColor,
                                            index,
                                            rectangleOptions.borderColor),
                                    borderWidth: custom.borderWidth
                                        ? custom.borderWidth
                                        : helpers.valueAtIndexOrDefault(dataset.borderWidth,
                                            index,
                                        ...
                                        if (data.labels.length && data.datasets.length) {
                                            return data.labels.map(function(label, i) {
                                                ...
                                                var fill = custom.backgroundColor
                                                    ? custom.backgroundColor
                                                    : valueAtIndexOrDefault(ds.backgroundColor,
                                                        i,
                        ...
                        Chart.controllers.line = Chart.DatasetController.extend({
                            ...
                            getPointRotation: function(point, index) {
                                ...
                                if (!isNaN(custom.rotation)) {
                                    ...
                                    pointRotation =
                                        helpers.valueAtIndexOrDefault(dataset.pointRotation, index, pointRotation);
                                }
                            ...
                            updateElement: function(point, index, reset) {
                                ...
                                point._model = {
                                    ...
                                    pointStyle: custom.pointStyle ||
                                        helpers.valueAtIndexOrDefault(dataset.pointStyle,
                                            index,
                            ...
                            setHoverStyle: function(element) {
                                ...
                                model.backgroundColor = custom.hoverBackgroundColor ||
                                    helpers.valueAtIndexOrDefault(dataset.pointHoverBackgroundColor,
                                        index,
                                ...
                                model.radius =
                                    custom.hoverRadius ||
                                    helpers.valueAtIndexOrDefault(dataset.pointHoverRadius,
                                        index,
                                ...
                                helpers.extend(point,
                                    {
                                        ...
                                        _model: {
                                            ...
                                            radius: custom.radius
                                                ? custom.radius
                                                : helpers.valueAtIndexOrDefault(dataset.pointRadius,
                                                    index,
                                                    pointElementOptions.radius),
                                            backgroundColor: custom.backgroundColor
                                                ? custom.backgroundColor
                                                : helpers.valueAtIndexOrDefault(dataset.pointBackgroundColor,
                                                    index,
                    ...
                    module.exports = Element.extend({
                        ...
                        calculateTickRotation: function() {
                            ...
                            if (labels.length && me.options.display && me.isHorizontal()) {
                                var originalLabelWidth =
                                    helpers.longestText(context, tickFont.font, labels, me.longestTextCache);
                        ...
                        fit: function() {
                            ...
                            if (tickOpts.display && display) {
                                var largestTextWidth =
                                    helpers.longestText(me.ctx, tickFont.font, labels, me.longestTextCache);
                                ...
                                if (isHorizontal) {
                                    ...
                                    var lastLabelWidth =
                                        computeTextSize(me.ctx, labels[labels.length - 1], tickFont.font);
                        ...
                        _autoSkip: function(ticks) {
                            ...
                            if (isHorizontal) {
                                ...
                                if ((longestRotatedLabel + optionTicks.autoSkipPadding) * tickCount >
                                    (me.width - (me.paddingLeft + me.paddingRight))) {
                                    skipRatio = 1 +
                                        Math.floor(((longestRotatedLabel + optionTicks.autoSkipPadding) * tickCount) /
                                            (me.width - (me.paddingLeft + me.paddingRight)));
                                }
                        ...
                        draw: function(chartArea) {
                            ...
                            var tickFontColor =
                                helpers.valueOrDefault(optionTicks.fontColor, globalDefaults.defaultFontColor);
                            var tickFont = parseFontOptions(optionTicks);
                            var majorTickFontColor =
                                helpers.valueOrDefault(optionMajorTicks.fontColor, globalDefaults.defaultFontColor);
                            var majorTickFont = parseFontOptions(optionMajorTicks);

                            var tl = gridLines.drawTicks ? gridLines.tickMarkLength : 0;

                            var scaleLabelFontColor =
                                helpers.valueOrDefault(scaleLabel.fontColor, globalDefaults.defaultFontColor);
                            ...
                            linear: function(tickValue, index, ticks) {
                                ...
                                if (tickValue !== 0) {
                                    ...
                                    if (maxTick < 1e-4) { // all ticks are small numbers; use scientific notation
                                        ...
                                        tickString =
                                            tickValue.toExponential(Math.floor(logTick) - Math.floor(logDelta));
                                    } else {
                        ...
                        var LinearScale = Chart.LinearScaleBase.extend({
                            ...
                            getTickLimit: function() {
                                ...
                                if (me.isHorizontal()) {
                                    ...
                                    var tickFontSize =
                                        helpers.valueOrDefault(tickOpts.fontSize, defaults.global.defaultFontSize);
                                    maxTicks = Math.min(tickOpts.maxTicksLimit ? tickOpts.maxTicksLimit : 11,
                ...
                function(require, module, exports) {
                    ...
                    module.exports = function(Chart) {
                        ...
                        function getPointLabelFontOptions(scale) {
                            ...
                            var fontSize =
                                helpers.valueOrDefault(pointLabelOptions.fontSize, globalDefaults.defaultFontSize);
                        ...
                        function drawPointLabels(scale) {
                            ...
                            var outerDistance =
                                scale.getDistanceFromCenterForValue(opts.ticks.reverse ? scale.min : scale.max);
                        ...
                        var LinearRadialScale = Chart.LinearScaleBase.extend({
                            setDimensions: function() {
                                ...
                                var tickFontSize =
                                    helpers.valueOrDefault(tickOpts.fontSize, globalDefaults.defaultFontSize);
                                me.drawingArea =
                                    opts.display
                            ...
                            draw: function() {
                                ...
                                if (opts.display) {
                                    ...
                                    var tickFontStyle = valueOrDefault(tickOpts.fontStyle,
                                        globalDefaults.defaultFontStyle);
                                    var tickFontFamily =
                                        valueOrDefault(tickOpts.fontFamily, globalDefaults.defaultFontFamily);
